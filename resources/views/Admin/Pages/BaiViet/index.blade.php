                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="mb-3">
                                    <label class="form-label">Tiêu đều</label>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="admin_id" id="admin_id" class="form-control" readonly>
                                    <option value= {{ Auth::guard('admin')->user()->id }}> {{ Auth::guard('admin')->user()->name }}
                                    </option>
                            </select>
                        </div>
                    ...
                    <div class=" modal-footer">
                        <button class="btn btn-primary modal-footertex  " type="button" data-bs-dismiss="modal">Đóng</button>
                ...
                axios
                    ...
                    .then((res) => {
                        ...
                        $.each(res.data.data, function(key, value) {
                            ...
                            content += '<td scope="col">' + value.name + '</td>';
